...
Combine \cleaver{} and the \texttt{Biostrings} R package\citep{Biostrings}:
<<>>=
...
the \texttt{UniProt.ws} R package\citep{UniProt.ws}.
<<>>=
## load UniProt.ws library
library("UniProt.ws")

## download sequences of Insulin/Somatostatin
s <- select(UniProt.ws, keys=c("P01308", "P61278"), cols=c("SEQUENCE"))
...
\texttt{BRAIN} R package\citep{BRAIN} is used to calculate the isotopic
