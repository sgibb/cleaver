...
#'  \tab not R F,L,W or Y \tab not P \tab - \cr
#'  \tab \tab - \tab not H,K, or R \tab not P F,L,W or Y \tab - \tab not P \tab - \cr
#' \code{pepsin} \tab Pepsin (pH>2) \tab - \tab not H,K or R \tab not P \tab not R F
#'  or L \tab  not P \tab - \cr
#'  \tab \tab - \tab not H,K or R \tab not P F or L \tab - \tab not P \tab - \cr
#' }
#'
#' Exceptions:
#' \tabular{llllllll}{
